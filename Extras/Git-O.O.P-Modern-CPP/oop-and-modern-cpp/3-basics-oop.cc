...
public:
    ...
    Person() {
        std::cout << "empty construc hello" << std::endl;
    }
    Person(int some_age) : age(some_age) {
        std::cout << "helo from some_age constrc" << std::endl;
    }
   ...
   //  }
    ...
    // Getter for age
    int getAge() const
    {   /////////first time you saw const on the right side of the function
